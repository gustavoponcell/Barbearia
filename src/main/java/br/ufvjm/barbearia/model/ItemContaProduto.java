...
/**
 * Representa um item de produto faturado dentro de uma conta de atendimento.
 */
public class ItemContaProduto {

    private final Produto produto;
    private final Quantidade quantidade;
    private final Dinheiro precoUnitario;

    public ItemContaProduto(Produto produto, Quantidade quantidade, Dinheiro precoUnitario) {
